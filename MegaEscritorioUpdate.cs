...
namespace MegaEscritorio
{
    class MegaDeskOrder
    {
        ...
        static void Main(string[] args)
        {
            ...
            calcPrice(ref deskOrder, ref surfacePrice, ref drawerPrice, ref matPrice, ref rushPrice, rushPrices);

            displayOrder(deskOrder, surfacePrice, drawerPrice, matPrice, rushPrice);

            writeFile(deskOrder, surfacePrice, drawerPrice, matPrice, rushPrice);
